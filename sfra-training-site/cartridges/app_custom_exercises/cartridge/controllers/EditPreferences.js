...
server.get(
  ...
  function (req, res, next) {
    ...
    customer.profile.custom.interestApparel == true
      ? (preferencesForm.interestApparel.checked = "checked")
      : "";
    customer.profile.custom.interestElectronics == true
      ? (preferencesForm.interestElectronics.checked = "checked")
      : "";
    customer.profile.custom.newsletter == true
      ? (preferencesForm.newsletter.checked = "checked")
      : "";
